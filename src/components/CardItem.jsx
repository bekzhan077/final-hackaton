    ...
    <div>
      <div class="card">
        <div class="card2">
          ...
          <img
            className="img-card"
            src="https://sputnik.kg/img/102605/15/1026051588_0:214:3067:1939_1920x0_80_0_0_c2b1efc89b3ad363dbdf7aa00fa51c43.jpg"
            alt="Talas"
          />
        </div>
      </div>
      <div class="card">
        <div class="card2">
          <div className="detail-home2">
            <h1>Issyl-Kol</h1>
            <span>
              Issyk-Kul (Kirg. Ysyk-Köl - “hot lake”) is a drainless lake in
              Kyrgyzstan. It is one of the 30 largest lakes in the world and
          ...
          <img
            className="img-card2"
            src="https://peakvisor.com/photo/Issyk-Kul-Region.jpg"
            alt="IK"
          />
        </div>
      </div>
      <div class="card">
        <div class="card2">
          ...
          <img
            className="img-card"
            src="https://www.open.kg/uploads/posts/2014-05/1400151021_big.photo.jpg"
            alt="Naryn"
          />
        </div>
      </div>
      <div class="card">
        <div class="card2">
          ...
          <img
            className="img-card2"
            src="https://24.kg/files/media/84/84812.jpg"
            alt="Batken"
          />
        </div>
      </div>
      <div class="card">
        <div class="card2">
          <div className="detail-home">
            <h1>Jalal-Abad</h1>
            <span>
              Jalal-Abad (also spelled Dzhalal-Abad, Djalal-Abat, Jalalabat;
              Kyrgyz: Жалал-Aбат, Calal-Abat/Jalal-Abat, جالال-ابات,
              [dʒɑlɑlɑbɑt]) is the administrative and economic centre of
              Jalal-Abad Region in southwestern Kyrgyzstan. Its area is 88
              square kilometres (34 sq mi),[2] and its resident population was
              123,239 in 2021.[1] It is situated at the north-eastern end of the
              Fergana valley along the Kögart river valley, in the foothills of
              the Babash Ata mountains, very close to the Uzbekistan border.
            </span>
          </div>
          <img
            className="img-card"
            src="https://sputnik.kg/img/102865/87/1028658740_0:476:5600:3626_1920x0_80_0_0_9cb096852e47d572b564b00afbfcd2b9.jpg"
            alt="Jalal-Abad"
          />
        </div>
      </div>
      <div class="card">
        <div class="card2">
          <div className="detail-home2">
            <h1>Osh</h1>
            <span>
              Osh (Kyrgyzstan Osh) is a city of republican subordination in
              Kyrgyzstan, the administrative center of the Osh region. Osh is
      ...
      <div class="card">
        <div class="card2">
          <div className="detail-home">
            <h1>Chui</h1>
            <span>
              Chüy Region (Kyrgyz: Чүй облусу, romanized: Chüy oblusu; Russian:
              Чуйская область, romanized: Chuyskaya oblast) is the northernmost
              region (oblast) of the Kyrgyz Republic. This region surrounds the
              national capital of Kyrgyzstan, Bishkek. It is bounded on the
              north by Kazakhstan, and clockwise, Issyk-Kul Region, Naryn
              Region, Jalal-Abad Region, and Talas Region. Its administrative
          ...
          <img
            className="img-card"
            src="https://24.kg/files/media/35/35290.jpg"
            alt="Chui"
          />
        </div>
      </div>
